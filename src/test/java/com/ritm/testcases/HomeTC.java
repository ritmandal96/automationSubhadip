...
import com.ritm.pages.Home_Page;
...
public class HomeTC extends Base {
	...
	public void HomePg(String UserName, String Password, String License) throws InterruptedException {
		...
		homepage.click_ForewardBtn();
		wait.wait(5000);
		homepage.click_ResourcesTab();
		wait.wait(5000);
		homepage.click_DownloadTab();
		wait.wait(5000);
		homepage.click_DocumentationTab();
		wait.wait(5000);
